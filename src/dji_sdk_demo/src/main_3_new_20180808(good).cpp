 ...
 //               writeF << g_pos_x  << g_pos_y << g_pos_z << endl;
                ...
                switch (state_in_mission) 
                {
                    ...
                    case 1://take off and forward,need to change height
                    {
                        ...
                        if((ob_distance[0]>serach_flight_height_1 - 1.5)&&ob_distance[0]<4)//set height 1.5m
                        {
                            for(int i = 0; i < 10; i ++)//cross_forward_count set to 10
                            {
                                if(i < 10)
                                    drone->attitude_control(0x4B,0.7,0,0,0);//NOT 0X42
                                else
                    ...
                    case 3://go up and forward,need to change forward distance!!!
                    {
                        switch(cross_state)
                        {
                            case 0:
                            {
                                ...
                                {
                                    //cross
                                    for(int i = 0; i < 150; i ++)//cross_forward_count set to 150
                                    {
                                    if(i < 150)
                                    drone->attitude_control(0x4B,0.7,0,0,0);//NOT 0X42
                                    else
